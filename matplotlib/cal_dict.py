    ...
    def cal_func(total, years = None, rate = None, loan_type = None):
        ...
        if(loan_type == "capital"):
            ...
            for x in range(1,months + 1):
                ...
                interest_list.append(interest_month)
                capital_list.append(capital_month)
                total_list.append(total_month)
                

            amount_list["months"] = months_list
            amount_list["interest_month"] = interest_list
            amount_list["capital_month"] = capital_list
            amount_list["total_month"] = total_list
